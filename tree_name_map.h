...
class TreetaxaMap {
    ...
    private: unsigned int tot_leaf;   //stores the total number of leaves int the tree  :RUCHI
    ...
    //return the number of total leaves :RUCHI
    public: inline unsigned int tot_leaves() {
        return tot_leaf;
    }

    //initialize the number of total leaves :RUCHI
    public: inline void init_tot_leaves() {
        tot_leaf = 0;
    }
